...
const newArr = myArray.join()  //join all elements to string by default(, by comma) ,
...
// const sliceArr = myArray.slice(1,3)  // second range exclusive
// console.log(sliceArr);
// console.log(myArray); // origial array didn't changed/manipulated

const spliceArr = myArray.splice(1,3)
console.log(spliceArr); // range inclusive + remove that slice/portion from original array
console.log(myArray); // origial array changed/manipulated
